...
function RailIcon({ icon }: { icon: React.ReactNode }) {
  return (
    <button className="flex h-[58px] w-[58px] items-center justify-center rounded-[1.15rem] border border-white/8 bg-[linear-gradient(180deg,rgba(18,37,58,0.92)_0%,rgba(11,28,45,0.98)_100%)] text-white/78 shadow-[0_14px_26px_rgba(0,0,0,0.16)] transition hover:border-[#D0A243]/28 hover:text-[#E7CB84]">
      {icon}
    </button>
  );
}
...
export default function AdminPage() {
    ...
    return (
      <div className="min-h-screen bg-[radial-gradient(circle_at_top,#13263c_0%,#091420_42%,#07111c_100%)] px-6 py-16 text-white">
        <div className="mx-auto max-w-5xl rounded-[2rem] border border-white/8 bg-[linear-gradient(180deg,rgba(11,27,45,0.98)_0%,rgba(8,19,31,0.98)_100%)] p-10 text-right shadow-[0_24px_60px_rgba(0,0,0,0.24)]">
          ...
          <h1 className="mt-3 font-['Tajawal'] text-[3rem] font-black text-white">الوصول يتطلب حساب أمانة مخوّل</h1>
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,#14263b_0%,#09131f_44%,#06101b_100%)] text-white">
      <div className="mx-auto flex min-h-screen max-w-[1760px] gap-4 px-2 py-2">
        <aside className="hidden w-[68px] shrink-0 rounded-[1.6rem] border border-white/8 bg-[linear-gradient(180deg,#0B1A2B_0%,#081321_100%)] px-2 py-5 shadow-[0_24px_60px_rgba(0,0,0,0.22)] xl:flex xl:flex-col xl:items-center xl:gap-2.5">
        ...
        <main className="min-w-0 flex-1 space-y-4">
          <header className="rounded-[1.7rem] border border-white/8 bg-[linear-gradient(180deg,rgba(8,19,31,0.94)_0%,rgba(8,20,33,0.98)_100%)] px-6 py-4 shadow-[0_24px_60px_rgba(0,0,0,0.24)]">
            <div className="flex items-center justify-between gap-6">
              <div className="flex items-center gap-3">
                ...
                <div className="border-r border-white/10 pr-5 text-right">
                  <p className="font-['Tajawal'] text-[1.1rem] font-black text-[#E4C982]">{authorityDisplayName}</p>
                ...
                <div className="border-r border-white/10 pr-5 text-right">
                  ...
                  <p className="font-['Tajawal'] text-[15px] font-bold text-white/85">10:30 AM</p>
                </div>
              </div>

              <div className="text-right">
                <h1 className="font-['Tajawal'] text-[2.85rem] font-black leading-none text-white">غرفة قيادة الاستثمار الحضري</h1>
                <p className="mt-2 font-['IBM_Plex_Sans_Arabic'] text-[13px] text-white/55">مركز القرار التنفيذي - أمانة منطقة حائل</p>
              </div>
            </div>
          </header>
          ...
          <div className="grid gap-3 xl:grid-cols-[repeat(4,minmax(0,1fr))_1.15fr]">
            {[
              ...
              <div key={String(title)} className="rounded-[1.2rem] border border-white/8 bg-[linear-gradient(180deg,rgba(11,27,45,0.96)_0%,rgba(10,23,38,0.98)_100%)] px-4 py-4 text-right shadow-[0_18px_44px_rgba(0,0,0,0.18)]">
                <div className="flex items-center justify-between">
                  ...
                  <div>
                    <p className="font-['Tajawal'] text-[1.05rem] font-black text-white">{title}</p>
            ...
            <div className="rounded-[1.2rem] border border-white/8 bg-[linear-gradient(180deg,rgba(11,27,45,0.96)_0%,rgba(10,23,38,0.98)_100%)] px-4 py-4 text-right shadow-[0_18px_44px_rgba(0,0,0,0.18)]">
              <div className="flex items-center justify-between">
                ...
                <div>
                  <p className="font-['Tajawal'] text-[1.05rem] font-black text-white">اسأل مساعد استنار الذكي</p>
        ...
        <aside className="w-[286px] shrink-0 rounded-[1.7rem] border border-white/8 bg-[linear-gradient(180deg,#091624_0%,#0B1C2F_100%)] px-4 py-4 shadow-[0_24px_60px_rgba(0,0,0,0.24)]">
          ...
          <div className="mt-5 rounded-[1.25rem] border border-white/8 bg-white/[0.03] px-4 py-4 text-right">
          ...
          <div className="mt-5 border-t border-white/8 pt-4">
            ...
            <p className="mt-7 text-center text-[12px] text-white/34">© 2024 استنار<br />جميع الحقوق محفوظة</p>
          </div>
        </aside>
      </div>
    </div>
