...
export default function IntelligenceWorkspaceShell({
  ...
  return (
    <div className="dashboard-shell min-h-screen" style={{ background: "linear-gradient(180deg, #F6F4EE 0%, #F2F0EA 48%, #EEF1F5 100%)" }}>
      <div className="mx-auto flex min-h-screen max-w-[1680px]">
        <aside
          className="hidden w-[292px] shrink-0 flex-col border-l border-white/10 p-5 xl:flex"
        ...
        >
          ...
          <div className="mt-6 space-y-3">
            <div className="rise-in stagger-1 rounded-[1.5rem] border border-white/10 bg-white/4 px-4 py-4 text-right">
              ...
              <p className="text-sm font-black text-white">{statusTitle}</p>
              <p className="mt-2 text-xs leading-7 text-white/58">{statusDescription}</p>
              <p className="mt-3 text-xs font-semibold text-[#E9DFC8]">{commandValue}</p>
            </div>
