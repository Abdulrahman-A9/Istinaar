    ...
    <header className="executive-header rounded-[1.25rem] border border-white/10 bg-[linear-gradient(115deg,rgba(13,34,53,0.98)_0%,rgba(8,22,36,0.98)_52%,rgba(11,29,46,0.98)_100%)] px-5 py-3.5 shadow-[0_18px_44px_rgba(0,0,0,0.2)]">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="border-r border-white/10 pr-4 text-right">
            <p className="text-[11px] text-white/52">الأربعاء 05/01/1448 هـ</p>
            <p className="mt-0.5 font-['Tajawal'] text-[1rem] font-black text-white">10:30 AM</p>
          </div>
          <button aria-label="الرسائل" className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/[0.04] text-white/80">
            <Mail size={17} />
          </button>
          <button aria-label="التنبيهات" className="relative flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/[0.04] text-white/80">
            <Bell size={17} />
          ...
          <button aria-label="الحساب" className="flex h-11 w-11 items-center justify-center rounded-full bg-[radial-gradient(circle_at_top,#F0E3BA_0%,#C89C45_100%)] text-[#0B1726] shadow-[0_14px_28px_rgba(208,162,67,0.22)]">
            <UserCircle2 size={19} />
          </button>
        </div>
      </div>
