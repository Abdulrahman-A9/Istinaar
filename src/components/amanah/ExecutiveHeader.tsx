...
export default function ExecutiveHeader({
  ...
  return (
    <header className="relative z-10 rounded-[28px] border border-white/10 bg-[radial-gradient(circle_at_60%_0%,rgba(234,193,112,0.1),transparent_22%),linear-gradient(135deg,#06101b,#0c1826)] px-5 py-4 shadow-[0_18px_44px_rgba(0,0,0,0.22)] sm:px-6">
